	...
	\begin{tcolorbox}[title=Remark,colframe=black,arc=10pt]
	It is not necessary to make complicated calculations to calculate the normalization factor of the exponential, as in the context of an integration over all space, the three factors of $Y_{m_l,l}(\theta,\phi)$ are independent of each other. Thus the integral is the product of the integrals (\SeeChapter{see section Differential and Integral Calculus page \pageref{integral calculus}}).
	\end{tcolorbox}
...
Let us check now the framed previous boxed relation (warning this is a bit long and it is advisable to read it several times):
  ...
  \multicolumn{1}{c}{\cellcolor{black!30}Nomenclature}\\ \hline
	...
	\begin{figure}[H]
		\centering
		\includegraphics{img/chemistry/hydrogen_ground_state.jpg}	
...
Orbital approximation
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=1]{img/chemistry/rotational_molecular_energy.jpg}
	\end{figure}
	Therefore, as: 
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.8]{img/chemistry/double_harmonic_oscillator.jpg}
	...
	with for recall $n\in \mathbb{N}$. More often denoted:
		...
		\begin{figure}[H]
		\centering
		\includegraphics[scale=1]{img/chemistry/vibrational_molecular_energy.jpg}
	\end{figure}
...
energy-level diagram like the one shown below can be constructed:
	\begin{figure}[H]
		\centering
		\includegraphics[scale=1]{img/chemistry/rotational_plus_vibrational_molecular_energy.jpg}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.65]{img/chemistry/six_states_of_matter.jpg}	
