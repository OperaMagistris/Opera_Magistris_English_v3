...
The waitress says "one third x cubed" and while walking away, turns back and says over her shoulder "plus a constant!"
	\begin{center}\underline{\hspace{5 cm}}\end{center}
	\begin{center}
		\includegraphics[scale=0.2]{img/humour/skeptics.jpg}	
	\end{center}
	\begin{center}\underline{\hspace{5 cm}}\end{center}
Teachers words:
...
\end{itemize}
	...
	\begin{center}
		\includegraphics[scale=0.9]{img/humour/boring.jpg}	
	\end{center}
...
\begin{center}\underline{\hspace{5 cm}}\end{center}
	...
	\begin{center}
		\includegraphics[width=1.0\textwidth]{img/humour/ultima_cena.jpg}	
	\end{center}
...
\end{center}
	...
	\begin{center}
		\includegraphics[scale=0.7]{img/humour/calculator_in_radian.jpg}	
	\end{center}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{img/humour/differentiation_and_integration.jpg}
		\caption[]{source: \url{www.xkcd.com} (author: Randall Munroe)}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.7]{img/humour/exponential_mother.jpg}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.5]{img/humour/aspirin_dn.jpg}
	\end{figure}
...
\end{enumerate}
	...
	\begin{center}\underline{\hspace{5 cm}}\end{center}
		\begin{center}
		\includegraphics[scale=0.7]{img/humour/travelling_light.jpg}	
	\end{center}
...
\begin{center}\underline{\hspace{5 cm}}\end{center}
	...
	\begin{center}
	\includegraphics[scale=0.6]{img/humour/schrodinger.jpg}
	\end{center}
...
\end{itemize}
	...
	\begin{center}
	\includegraphics[scale=0.6]{img/humour/major_physics.jpg}
	\end{center}
	
	\begin{center}\underline{\hspace{5 cm}}\end{center}

	\begin{center}
	\includegraphics[scale=0.9]{img/humour/neutron.jpg}
	\end{center}
	
	\begin{center}\underline{\hspace{5 cm}}\end{center}

	\begin{center}
	\includegraphics[scale=0.8]{img/humour/particles.jpg}
	\end{center}
	
	\begin{center}
	\includegraphics[scale=0.36]{img/humour/thermodynamics.jpg}
	\end{center}
	
	\begin{center}\underline{\hspace{5 cm}}\end{center}
	
	\begin{center}
	\includegraphics[scale=0.36]{img/humour/glas.jpg}
	\end{center}
	
	\begin{center}
	\includegraphics[scale=0.5]{img/humour/maths_behind_physics.jpg}
	\end{center}
	
	\begin{center}\underline{\hspace{5 cm}}\end{center}
	
	\begin{center}
	\includegraphics[scale=0.4]{img/humour/student_assassination.jpg}
	\end{center}
	
	\begin{center}
	\includegraphics[scale=0.5]{img/humour/lagrangian.jpg}
	\end{center}
...
\end{enumerate} 
	...
	\begin{center}\underline{\hspace{5 cm}}\end{center}
	\begin{center}
	\includegraphics[scale=0.3]{img/humour/normal_distribution.jpg}
	\end{center}
	\begin{center}\underline{\hspace{5 cm}}\end{center}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.45]{img/humour/curve_fitting.jpg}
		\caption[]{source: \url{www.xkcd.com} (author: Randall Munroe)}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.35]{img/humour/type_of_errors.jpg}
		\caption[]{source: \url{www.xkcd.com} (author: Randall Munroe)}
	\end{figure}
	...
	\begin{center}
	\includegraphics[width=1.0\textwidth]{img/humour/pdf.jpg}
	\end{center}
...
\end{itemize}
	...
	\begin{center}
		\includegraphics[scale=0.7]{img/humour/wet_floor.jpg}	
	\end{center}
	...
	Students:
	\begin{center}
		\includegraphics[scale=0.5]{img/humour/o.jpg}	
	\end{center}
	...
	\begin{center}
	\includegraphics[scale=0.2]{img/humour/appeal_to_nature.jpg}
	\end{center}

	\pagebreak
	\section{Engineering}

	Scientists at NASA built a device to launch dead chickens at the wind-shields of airliners, military jets, the space shuttle, etc. The idea being to simulate collisions with airborne fowl to test the strength of the wind-shields. 
...
\end{enumerate}
	...
	\begin{center}
	\includegraphics[scale=0.9]{img/humour/farenheit_vs_celsius_vs_kelvin.jpg}
	\end{center}
...
\end{itemize}
	...
	\begin{center}
	\includegraphics[scale=1]{img/humour/model_vs_models.jpg}
	\end{center}
